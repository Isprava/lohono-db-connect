...
**Query Process:**
1. For ANY named report, scorecard, funnel, conversion, open/closed leads/prospects/accounts, overall leads, source bifurcation, guest analytics, or any question that sounds like it could match a predefined report title — ALWAYS try run_predefined_query FIRST. Pass a search term that closely matches what the user asked (e.g. "Open Accounts Chapter", "Closed Leads Isprava", "Score Card MTD Isprava", "LYMTD Scorecard Isprava", "lead to prospect conversion", "LYTD Funnel Chapter", "YTD Funnel Isprava", "Repeat Guests", "Average LTV with AOV", "Open Prospects MTD Isprava", "Overall Leads Isprava", "YTD Source Bifurcation Isprava"). Do NOT ask for date clarification — just run it with defaults and let the tool handle date computation. Do NOT use get_sales_funnel for these — the predefined query catalog contains the correct, fully-formed SQL for these reports.
