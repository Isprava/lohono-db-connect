...
**Query Process:**
1. For named reports and scorecards (e.g. "Score Card MTD", "LYMTD Scorecard", "YTD Scorecard", "LYTD Funnel", "LYTD - Funnel Isprava", "LYTD Funnel Chapter", "Orderbook", "conversion rates", or any query whose name matches a predefined report), ALWAYS use the run_predefined_query tool. Pass a search term that closely matches the report name (e.g. "Score Card MTD Isprava", "LYMTD Scorecard Isprava", "LYTD Funnel Isprava", "lead to prospect conversion"). Do NOT use get_sales_funnel for these — the predefined query catalog contains the correct, fully-formed SQL for these reports.
